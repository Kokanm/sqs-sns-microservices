...
app.post("/send", async (req, res) => {
  ...
  try {
    ...
    console.log(`MicroSVC1 | SUCCESS: ${publishTextPromise.MessageId}`);
    res.send("Thank you for sending data to MicroSVC2 and MicroSVC3.");
  } catch (err) {
    console.log(`MicroSVC1 | ERROR: ${err}`);
